    ...
    switch (opção) {
        ...
        case 10:
            printf ("Opção 10 foi escolhida\n");
                ...
                float Reais;
                int x, real1, centavo50, centavo25, centavo10, centavo5, centavo1; //Determinando as variáveis

                printf ("FORA BOZO\n");
                printf ("Insira o valor do produto que será pago em Reais\n");
                scanf ("%f", &Reais);
                
                real1 = (int)Reais; //Pega apenas a parte inteira do valor inserido
                printf ("Serão necessárias:\n");
                printf ("%d moeda(s) de 1 real\n", real1); //Determinando e mostrando quantas moedas de 1 real serão necessárias
                x = (Reais - real1 + 0.005) * 100;
                centavo50 = x/50;
                printf ("%d moeda(s) de 50 centavos\n", centavo50); //Determinando e mostrando quantas moedas de 50 centavos serão necessárias
                x = x % 50;
                centavo25 = x/25;
                printf ("%d moeda(s) de 25 centavos\n", centavo25); //Determinando e mostrando quantas moedas de 25 centavos serão necessárias
                x = x % 25;
                centavo10 = x/10;
                printf ("%d moeda(s) de 10 centavos\n", centavo10); //Determinando e mostrando quantas moedas de 10 centavos serão necessárias
                x = x % 10;
                centavo5 = x/5;
                printf ("%d moeda(s) de 5 centavos\n", centavo5); //Determinando e mostrando quantas moedas de 5 centavos serão necessárias
                x = x % 5;
                centavo1 = x;
                printf ("%d moeda(s) de 1 centavo\n", centavo1); //Determinando e mostrando quantas moedas de 1 centavo serão necessárias
        break;
        }
    return 0;
    }
